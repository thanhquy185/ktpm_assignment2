...
- TC7: Test quantity lớn hơn stock trên cùng 1 sản phẩm
...
- TC5: Giỏ hàng có sản phẩm và tăng số lượng 1 sản phẩm
- TC4: Giỏ hàng có sản phẩm và giảm số lượng 1 sản phẩm
- TC6: Giỏ hàng có sản phẩm và xoá 1 sản phẩm

#### Phân công

| Thành viên     | Component              |
| -------------- | ---------------------- |
| Trần Thanh Quy | Cart (TC1, TC2 và TC6) |
| Đỗ Nhật Huy    | Cart (TC3 → TC5)       |
...
- Tổng tiền: **_"price-calculator-total-price"_** | {}
...
- TC1: Tính tổng tiền đơn hàng thành công

#### Phân công

| Thành viên           | Component                           |
| -------------------- | ----------------------------------- |
| Nguyễn Đình Quốc Huy | Checkout Summary + Price Calculator |
...
- TC7: Tạo đơn hàng nhưng tồn kho của tồn kho không tồn tại
- TC8: Tạo đơn hàng nhưng tồn kho của sản phẩm không tồn tại
- TC9: Tạo đơn hàng nhưng tồn kho của sản phẩm không đủ (giảm tồn kho sản phẩm)
- TC10: Tạo đơn hàng nhưng người dùng không tồn tại
- TC11: Tạo đơn hàng nhưng mã giảm giá không tồn tại
- TC12: Tạo đơn hàng nhưng mã giảm giá hết hạn

#### Phân công

| Thành viên           | Test case  |
| -------------------- | :--------: |
| Danh Thị Ngọc Châu   | TC1 → TC6  |
| Nguyễn Đình Quốc Huy | TC7 → TC12 |
